...
my_parser.add_argument(
    ...
    action="store_true",
    required=False,
    help="Notify podwords of feeds via http POST. Requires environment variable PODWORDS_WEB_HOST to be set.",
)
...
class Config:
    ...
    notify_podwords = my_args["notify_podwords"]
    ...
    def setup(cls, client: Client):
        ...
        if cls.notify_podwords:
            cls.notify_podwords = True
